...
namespace Papirus.WebApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240221232846_InitialMigration")]
            ...
            modelBuilder.Entity("Papirus.WebApi.Domain.Entities.Firm", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            GuidIdentifier = new Guid("0babfb2b-19cc-4538-bbaf-77c6f2fbfbb4"),
                            Name = "Gómez Pineda Abogados"
                        },
                        new
                        {
                            Id = 2,
                            GuidIdentifier = new Guid("bcc332b6-b268-49d5-a6ab-e29964e7a850"),
                            Name = "Alianza"
                        });
                });
            ...
            modelBuilder.Entity("Papirus.WebApi.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 2, 21, 17, 28, 46, 446, DateTimeKind.Local).AddTicks(5424),
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "User",
                            RegistrationDate = new DateTime(2024, 2, 21, 17, 28, 46, 446, DateTimeKind.Local).AddTicks(5442),
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "User",
                            RegistrationDate = new DateTime(2024, 2, 21, 17, 28, 46, 446, DateTimeKind.Local).AddTicks(5444),
                            RoleId = 3,
